...
public class Task5 {
    public static void main(String[] args) {
        ...
        shop[0] = "R6";     price[0] = 699.0f;
        shop[1] = "COD";    price[1] = 2000.0f;
        shop[2] = "PUBG";   price[2] = 0.0f;
        shop[3] = "DBD";    price[3] = 1159.0f;
        shop[4] = "CS2";    price[4] = 0.0f;
        shop[5] = "GTA5";   price[5] = 2499.0f;
        shop[6] = "RDR2";   price[6] = 4999.0f;
        shop[7] = "RE9";    price[7] = 4399.0f;
        shop[8] = "NFS";    price[8] = 1000.0f;
        shop[9] = "POE2";   price[9] = 2532.0f;
        ...
        while (true) {
            ...
            for (int i = 0; i < shop.length; i++) {
                ...
                if (input.toLowerCase().equals(shop[i].toLowerCase())) {
